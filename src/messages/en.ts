...
export const en: Messages = {
  ...
  domains: {
    ...
    authCodePlaceholder: "Auth code (optional)",
    transferThis: "Is it yours? Move it here",
    transferHint: "Remove the transfer lock at your current registrar first. If you do not have the code yet, we ask for it at checkout.",
