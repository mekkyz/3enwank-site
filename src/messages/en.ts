...
export const en: Messages = {
  ...
  // status.3enwank.com (platform docs/design/status-page.md 6.7). Percent signs are in the templates, so {percent} is a bare number.
  status: {
    metaTitle: "{brand} status",
    description: "Whether our websites, email, control panel, FTP and customer area are running, with recent incidents and planned maintenance.",
    heading: "Service status",
    header: "Status",
    updated: "Updated {time} Cairo time",
    unavailable: "Status is temporarily unavailable. Please check again in a few minutes.",
    services: "Services",
    ...
    noUptime: "No data yet",
    barDay: "{date}: {state}, {percent}%",
    barState: "{date}: {state}",
    barNoData: "{date}: no data",
    barSummary: "Last 90 days: {running} running normally, {issues} with some issues, {down} not working, {maintenance} with maintenance, {none} with no data.",
    problemDays: "Days with problems: {days}.",
    ...
    sameDay: "{date}, {from} to {to} Cairo time",
    acrossDays: "{date}, {from} to {toDate}, {to} Cairo time",
    since: "{date}, since {from} Cairo time",
    back: "Back to {site}",
