...
export const en: Messages = {
  ...
  contact: {
    ...
    lede: "WhatsApp is the fastest way to reach one of us. Not a call centre, and not the robot in the corner. If you would rather write it down, the short form below reaches the same people.",
    wa: {
      kicker: "Fastest way to reach us",
      title: "Message us on WhatsApp",
      cta: "Open WhatsApp",
      call: "The same number works as a phone.",
      voice: "Voice notes are fine.",
      hours: "Sunday to Thursday, 9:00 to 18:00, Cairo time. Inside those hours we usually answer within the hour. Send it whenever you like: anything that arrives after we close is answered the next working morning.",
      defaultText: "Hello 3enwank. I came from your website and I have a question.",
      openersTitle: "Not sure what to write? Start with one of these:",
      openers: [
        { chip: "I need hosting", text: "Hello 3enwank. I need hosting for my website." },
        { chip: "I want a website", text: "Hello 3enwank. I want a website built. Here is what it is for:" },
        { chip: "Move my site to you", text: "Hello 3enwank. I want to move my site to you from another host. My domain is:" },
      ],
      open: "Open now",
      closedToday: "Closed now. We open at 9:00 today.",
      closedTomorrow: "Closed now. Back tomorrow at 9:00.",
      closedWeekend: "Closed for the weekend. Back Sunday at 9:00.",
    },
    languages: {
    ...
    urgent: {
      ...
      body: "If you are already a customer, do not use the form below. That one goes to sales and waits for working hours. Use one of these instead, and put your domain name in the first line.",
      wa: "Message us on WhatsApp",
      waText: "URGENT. My site is down. My domain is:",
      ticket: "Open a ticket in your account",
      email: "Write to {email}",
      emailSubject: "Site down:",
      after: "Outside working hours a ticket is the one that leaves a record, and it is the first thing read at 9:00.",
    },
    email: "Email",
    emailBody: "New projects, quotes, and anything that is not urgent. You get an answer the same working day.",
    address: "Visit",
    addressBody: "By appointment. Message us first so someone is there to meet you.",
    existing: "Already a customer?",
    existingBody: "Invoices, hosting details, domains and support tickets are in your customer area.",
    existingCta: "Open the customer area",
    form: {
      title: "Rather write it down?",
      lede: "Three short answers. It opens a ticket with the sales side of the company and a person reads it, the same person who would have answered on WhatsApp. Not for urgent support: use the line above for that.",
      needLegend: "What do you need?",
      need: { hosting: "Hosting", website: "A new website", move: "Move my site to you", care: "A care plan", other: "Something else" },
      name: "Your name",
      reach: "WhatsApp number or email",
      reachHint: "Whichever you would rather we used.",
      note: "Anything we should know?",
      noteHint: "Optional. A link to your current site tells us more in ten seconds than a paragraph would.",
      notePlaceholder: "One or two lines is plenty.",
      submit: "Send it",
      sending: "Sending",
      errorTitle: "Nothing was sent yet. Please fix these:",
      errors: {
        need: "Choose what you need, so this reaches the right person.",
        name: "Tell us what to call you.",
        reach: "Add a WhatsApp number or an email address, or we have no way to answer you.",
        reachFormat: "That is not a phone number or an email address. Please check it.",
      },
      sentTitle: "Got it.",
      sentBody: "It is in our sales queue with your name on it. We will answer {reach} the same working day.",
      sentWa: "In a hurry? WhatsApp is faster.",
      sentAgain: "Send another message",
      failed: "That did not send, and nothing was lost: your text is still in the boxes. Try again, or reach us on WhatsApp or by email.",
      limited: "That is a lot of messages from one connection. Wait a minute and try again, or use WhatsApp.",
      privacy: "What you send opens a ticket in our sales queue and is used only to answer you. It is not added to a mailing list and it is not passed to anyone else.",
    },
  },
  terms: {
