...
export const en: Messages = {
  ...
  care: {
    ...
    explainTitle: "What each line means",
    explain: [
      { title: "Updates", body: "WordPress core, the plugins and the theme. Monthly on Basic, every 2 weeks on Plus, weekly on Pro. On Plus and Pro every update is tried on a copy of your site first, so a broken one never reaches your visitors." },
      { title: "Malware", body: "Every file is scanned for known infections. Basic tells you what it found; Plus and Pro clean it out, and Pro scans weekly." },
      { title: "Content changes", body: "One clear edit that takes half an hour or less with the design and content already there: a price, a photo, a new team member. New pages, new features and design work are quoted separately." },
      { title: "Reply time", body: "How long before a person answers your message, counted in working days, Sunday to Thursday." },
      { title: "Emergency restores", body: "Putting the site back from a backup after something breaks it: a bad plugin, a wrong edit, an intrusion." },
      { title: "Reports", body: "A short written note of what was updated, what the scan found, and what changed on the site." },
      { title: "Stores", body: "Care Pro places a test order after every update, so a payment or checkout that stopped working is found by us and not by a customer." },
      { title: "If you stop", body: "Upkeep stops when a plan is not renewed. The website stays online." },
    ],
  ...
  domains: {
    ...
    moreTlds: "These are the most popular endings. Search above for any other one.",
