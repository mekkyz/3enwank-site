...
const PRIORITY: Partial<Record<PageKey, number>> = { home: 1, hosting: 0.9, websites: 0.9, care: 0.8, domains: 0.8, about: 0.5, contact: 0.6, terms: 0.2, privacy: 0.2, delivery: 0.2, refunds: 0.2 };
