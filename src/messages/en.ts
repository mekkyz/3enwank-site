...
export const en: Messages = {
  ...
  contact: {
    ...
    existingBody: "Invoices, hosting, domains and tickets are in your account.",
    ...
    form: {
      ...
      failed: "That did not send, and your text is still in the boxes. Try again, or use WhatsApp.",
